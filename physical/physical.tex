...
Figure \ref{fig:physical:py_vs_cpp} shows performances of two \ac{ros2} nodes with the same set of features, but in different programming languages, Python and C++.
