...
In the scope of the project, only wheel encoders are used for odometry.
...
As it is a non-linear system of differential equations we can integrate it using one of the methods for the numeric integration.
